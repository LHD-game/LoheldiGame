...
Shader "Nicrom/NHP/ASE/Vegetation Studio/Stylised Flower With Stem"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 RotationAxis56_g132 = MB_RotationAxis1420;
			...
			float4 StaticWorldNoise31_g131 = StaticNoise1340;
			float4 transform8_g131 = mul(unity_ObjectToWorld,float4( 0,0,0,1 ));
			...
			float MB_RotationAngle97 = radians( ( ( ( ( MB_Amplitude880 + ( MB_AmplitudeOffset1356 * (StaticWorldNoise31_g131).x ) ) * sin( ( ( ( transform8_g131.x + transform8_g131.z ) + ( ( _Time.y * ( MB_Frequency873 + ( MB_FrequencyOffset1525 * (StaticWorldNoise31_g131).x ) ) ) + ( ( 2.0 * UNITY_PI ) * DB_PhaseShift928 ) ) ) * MB_Phase1360 ) ) ) + MB_DefaultBending877 ) * ( ase_vertex3Pos.y / MB_MaxHeight1335 ) ) );
			float RotationAngle54_g132 = MB_RotationAngle97;
			float3 PivotPoint60_g132 = LocalPivot1504;
			float3 break62_g132 = PivotPoint60_g132;
			float3 appendResult45_g132 = (float3(break62_g132.x , ase_vertex3Pos.y , break62_g132.z));
			float3 rotatedValue30_g132 = RotateAroundAxis( appendResult45_g132, ase_vertex3Pos, RotationAxis56_g132, RotationAngle54_g132 );
			...
			float3 rotatedValue34_g132 = RotateAroundAxis( PivotPoint60_g132, ( rotatedValue30_g132 + DB_VertexOffset769 ), RotationAxis56_g132, RotationAngle54_g132 );
			float3 temp_output_1533_0 = ( ( rotatedValue34_g132 - ase_vertex3Pos ) * step( 0.01 , ase_vertex3Pos.y ) );
...
/*ASEBEGIN
Version=18500
2194.286;690.1429;1156;656;2609.232;-3928.406;1.178473;True;False
Node;AmplifyShaderEditor.CommentaryNode;490;-2426.842,3970.215;Inherit;False;893.0554;638.0813;;10;1458;1457;1455;1456;928;738;1504;1503;1502;1817;Vertex Colors and UVs Baked Data;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.NegateNode;1817;-1955.179,4452.824;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;1504;-1771.927,4446.932;Inherit;False;LocalPivot;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;1533;64.104,2854.921;Inherit;False;MainBending - NHP;-1;;132;01dba1f3bc33e4b4fa301d2180819576;0;4;55;FLOAT3;0,0,0;False;53;FLOAT;0;False;59;FLOAT3;0,0,0;False;58;FLOAT3;0,0,0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=F1C556325D473D8BCA9970662E4F7F659FF7039C