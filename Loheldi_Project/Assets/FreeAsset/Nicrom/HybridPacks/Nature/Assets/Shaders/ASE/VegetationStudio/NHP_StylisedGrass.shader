...
Shader "Nicrom/NHP/ASE/Vegetation Studio/Stylised Grass"
{
	Properties
	{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float4 StaticWorldNoise31_g120 = StaticWorldSpaceNoise1340;
			float4 transform8_g120 = mul(unity_ObjectToWorld,float4( 0,0,0,1 ));
			...
			float MB_RotationAngle97 = radians( ( ( ( ( MB_Amplitude880 + ( MB_AmplitudeOffset1356 * (StaticWorldNoise31_g120).x ) ) * sin( ( ( ( transform8_g120.x + transform8_g120.z ) + ( ( _Time.y * ( MB_Frequency873 + ( MB_FrequencyOffset1525 * (StaticWorldNoise31_g120).x ) ) ) + ( ( 2.0 * UNITY_PI ) * DB_PhaseShift928 ) ) ) * MB_Phase1360 ) ) ) + MB_DefaultBending877 ) * ( ase_vertex3Pos.y / MB_MaxHeight1335 ) ) );
...
/*ASEBEGIN
Version=18500
2194.286;690.1429;1156;656;4705.647;-3853.208;1;True;False
Node;AmplifyShaderEditor.CommentaryNode;490;-4485.178,3842.801;Inherit;False;898.3826;507.6482;;6;928;738;1504;1503;1502;1654;Vertex Colors and UVs Baked Data;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.NegateNode;1654;-3993.647,4169.208;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;1504;-3816.067,4164.518;Inherit;False;Pivot;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=EC31179EE82B1A781241B3EBC836FEAA470EC194