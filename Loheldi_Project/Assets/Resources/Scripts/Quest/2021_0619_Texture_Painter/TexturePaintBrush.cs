    ...
    public class TexturePaintBrush : MonoBehaviour
    {
        ...
        ***********************************************************************/
        ...
        private void Awake()
        {
            ...
            _camera = GameObject.Find("DrawCamera").GetComponent<Camera>();
        ...
        private void Update()
        {
            ...
            if (Physics.Raycast(_camera.ScreenPointToRay(Input.mousePosition), out var hit)) // delete previous and uncomment for mouse painting
            {
